 ...
 */
const get = async (options: CartQueryVariables): Promise<CartQuery['cart']> => {
...
const create = async (
  ...
  const response = (await query(CART_CREATE, options)) as {
...
const addLines = async (
  ...
  const response = (await query(CART_LINES_ADD, options)) as {
...
const removeLines = async (
  ...
  const response = (await query(CART_LINES_REMOVE, options)) as {
...
const updateLines = async (
  ...
  const response = (await query(CART_LINES_UPDATE, options)) as {
...
const updateBuyerIdentity = async (
  ...
  const response = (await query(CART_BUYER_IDENTITY_UPDATE, options)) as {
    data?: CartBuyerIdentityUpdateMutation;
  };
